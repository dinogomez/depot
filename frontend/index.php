...
<html lang="en" dir="ltr">
  <head>
    <link rel="icon" href="img/depot-favicon.png">
  ...
  <body>
    ...
    <!-- <div class="d-flex justify-content-center">
      <div class="jumbotron vertical-center">
        <h1 class="display-3 text-center border-bottom border-primary"><span class="purple-nav">.</span>DEPOT</h1>
        <p class="lead">Depot is a Team Fortress 2 Trading Site.</p>
        <hr class="my-2">
        <p>.DEPOT is not affiliated with STEAM.</p>
        <p class="lead">
          <a class="btn btn-primary btn-md" href="#!" role="button">Browse</a>
    ...
    <nav class="navbar fixed-bottom footer-copyright">
      <div class="container-fluid-nav text-center w-100">POTTEDPLANT</div>
    </nav>
  </body>
</html>
